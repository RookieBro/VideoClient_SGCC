...
//        Dialog dialog = new Dialog(getActivity(), R.style.Dialog_NoTitle);
        Dialog dialog = new Dialog(getActivity(), R.style.AnimationPicker);
    ...
    View initView() {
        ...
        Button btn_timer_sure = (Button) view.findViewById(R.id.btn_timer_sure);
        sure.setOnClickListener(this);
        btn_timer_sure.setOnClickListener(this);
        ...
        toolbar.setBackgroundColor(mPickerConfig.titlebarColor);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.tv_cancel) {
            dismiss();
        } else if (i == R.id.tv_sure || i == R.id.btn_timer_sure) {
            sureClicked();
        }
    }

    /*
    * @desc This method returns the current milliseconds. If current milliseconds is not get,
