...
public class CircleImageView extends ImageView {
    ...
    private Bitmap getBitmapFromDrawable(Drawable drawable) {
        ...
        try {
            ...
            if (drawable instanceof ColorDrawable) {
                ...
                if (intrinsicWidth <= 0) {
                    intrinsicWidth = UIUtils.dip2px(50);
                }
                if (intrinsicHeight <= 0) {
                    intrinsicHeight = UIUtils.dip2px(50);
                }
    ...
    private void setup() {
        ...
        int paddingTop_Bottom = Math.max(getPaddingTop(), getPaddingBottom());
        int paddingLeft_Right = Math.max(getPaddingLeft(), getPaddingRight());
